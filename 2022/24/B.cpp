...
int t_max = 1000;
int bfs(int s_t, int s_y, int s_x, int t_y, int t_x)
{
...
void solve()
{
    ...
    int ans = 0;
    int t1 = bfs(0, -1, 0, m - 1, n - 1);
    ans += t1;
    int t2 = bfs(t1, m, n - 1, 0, 0);
    ans += t2 - t1;
    int t3 = bfs(t2, -1, 0, m - 1, n - 1);
    ans += t3 - t1 - (t2 - t1);
    printf("t1=%d t2=%d t3=%d ans=%d\n", t1, t2 - t1, t3 - t1 - (t2 - t1), ans);
}
